...
case 'infogempa':
  reply(mess.wait)
  anu = await fetchJson(`https://free-zee.herokuapp.com/api/infogempa?apikey=${zeeapi}`,{method: 'get'})
  teks = ` [ *INFO GEMPA* ]\n\nWaktu : ${anu.result.Waktu}\nLintang : ${anu.result.Lintang}\nBujur : ${anu.result.Bujur}\nMagnitudo : ${anu.result.Magnitudo}\nKedalaman : ${anu.result.Kedalaman}\nWilayah : ${anu.result.Wilayah}\n\n_By : ${namabot}_`
  reply(teks)
  break
case 'coviddunia':
  reply(mess.wait)
  anu = await fetchJson(`https://free-zee.herokuapp.com/api/covidworld?apikey=${zeeapi}`,{method: 'get'})
...
case 'kusonime':
  ...
  anu = await fetchJson(`https://free-zee.herokuapp.com/api/anime/kusonime?search=${q}&apikey=${zeeapi}`,{method: 'get'})
  ...
  break
case 'tebakgambar':
  anu = await fetchJson(`https://free-zee.herokuapp.com/api/kuis/tebakgambar?apikey=${zeeapi}`,{method: 'get'})
  ...
  break
case 'caklontong':
  anu = await fetchJson(`https://free-zee.herokuapp.com/api/kuis/caklontong?apikey=${zeeapi}`,{method: 'get'})
...
case 'fakedata':
  reply(mess.wait)
  anu = await fetchJson(`https://free-zee.herokuapp.com/api/fakedata?country=en&apikey=${zeeapi}`,{method: 'get'})
...
case 'meme':
  reply(mess.wait)
  anu = await fetchJson(`https://free-zee.herokuapp.com/api/random/meme?apikey=${zeeapi}`,{method: 'get'})
...
case 'translate':
  ...
  anu = await fetchJson(`https://free-zee.herokuapp.com/api/translate?kata=${q}&apikey=${zeeapi}`)
teks = `[ *TRANSLATE* ]\n\nTeks kamu : ${q}\nHasil : ${anu.result.text}`
reply(teks)
break
case 'quotes':
  reply(mess.wait)
  anu = await fetchJson(`https://free-zee.herokuapp.com/api/randomquote?apikey=${zeeapi}`)
  teks = `[ *QUOTES* ]\n\n${anu.result.quotes}\n\n_#${nameowner}_`
  fakestatus(teks)
  break
case 'admin':
