...
❏ *${namabot}* ❏`
//anu = await fetchJson(`https://api-zeevalya.herokuapp.com/api/textmaker/metallic?text=${namabot}&theme=glow&apikey=${zeeapi}`)
////nase = fs.readFileSync('./stik/thumb.jpeg')
nase = await getBuffer('https://telegra.ph/file/82293edf3f8de35360962.jpg')
