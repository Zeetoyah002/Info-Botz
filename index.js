...
╭──❲ *MAKER* ❳
│• ${prefix}sticker_
│• ${prefix}swm_ <author|packname>
│• ${prefix}take_ <author|packname>
│• ${prefix}fdeface_
│• ${prefix}emoji_
│• ${prefix}night_ <teks>
│• ${prefix}glow_ <teks>
│• ${prefix}sky_ <teks>
│• ${prefix}cslogo_ <teks>
│• ${prefix}phlogo_ <teks|teks>
│• ${prefix}avanger_ <teks|teks>
│• ${prefix}glitch_ <teks|teks>
│• ${prefix}wolf_ <teks>
╰────────────────⊱ 	
...
╭──❲ *DOWNLOAD* ❳
│• ${prefix}ytsearch_ <query>
│• ${prefix}igstalk_ <query>
│• ${prefix}play_ <query>
│• ${prefix}video_ <query>
│• ${prefix}ytmp3_ <link>
│• ${prefix}ytmp4_ <link>
│• ${prefix}ig_ <link>
│• ${prefix}igstory_ <username>
│• ${prefix}twitter_ <link>
│• ${prefix}tiktok_ <link>
│• ${prefix}tiktokaudio_ <link>
│• ${prefix}fb_ <link>
│• ${prefix}brainly_ <query>
│• ${prefix}image_ <query>
│• ${prefix}anime_ <random>
│• ${prefix}pinterest_ <query>
│• ${prefix}komiku_ <query>
│• ${prefix}lirik_ <query>
│• ${prefix}chara_ <query>
│• ${prefix}playstore_ <query>
│• ${prefix}otaku_ <query>
│• ${prefix}kusonime_ <query>
│• ${prefix}waifu_
╰────────────────⊱ 	
...
case 'night':
  	if (args.length < 1) return reply('masukan teks')
   anu1 = body.slice(7)
  anu = await fetchJson(`https://api-zeevalya.herokuapp.com/api/maker3d/no4?text=${anu1}&apikey=${zeeapi}`,{method: 'get'})
reply(mess.wait)
...
case 'glow':
  	if (args.length < 1) return reply('masukan teks')
   anu1 = body.slice(6)
  anu = await fetchJson(`https://api-zeevalya.herokuapp.com/api/textmaker/metallic?text=${anu1}&theme=glow&apikey=${zeeapi}`,{method: 'get'})
reply(mess.wait)
...
case 'waifu':
					reply(mess.wait)
					amel = await getBuffer(`https://leyscoders-api.herokuapp.com/api/random-waifu?apikey=dappakntlll`)
					Christ.sendMessage(from, amel, image, {caption: `Waifumu mas :v`, quoted: mek})
					break
case 'sky':
					if (args.length < 1) return reply('masukan teks')
					Zee = body.slice(5)
					reply(mess.wait)
					amel = await getBuffer(`https://api.zeks.xyz/api/skytext?apikey=apivinz&text=${q}`)
					Christ.sendMessage(from, amel, image, {caption: `Sky ${q}`, quoted: mek})
					break
case 'cslogo':
					if (args.length < 1) return reply('masukan teks')
					reply(mess.wait)
					amel = await getBuffer(`https://api.zeks.xyz/api/cslogo?apikey=apivinz&text=${q}`)
					Christ.sendMessage(from, amel, image, {caption: `Cslogo ${q}`, quoted: mek})
					break
case 'wolf':
					if (args.length < 1) return reply('masukan teks')
					reply(mess.wait)
					amel = await getBuffer(`https://api.zeks.xyz/api/wolflogo?apikey=apivinz&text1=By:${namabot}&text2=${q}`)
					Christ.sendMessage(from, amel, image, {caption: `Wolf ${q}`, quoted: mek})
					break
case 'avanger':
					  pe = args.join('')
            var a = pe.split("|")[0];
            var b = pe.split("|")[1];
					reply(mess.wait)
					amel = await getBuffer(`https://api.zeks.xyz/api/logoaveng?apikey=apivinz&text1=${a}&text2=${a}`)
					Christ.sendMessage(from, amel, image, {caption: `Avanger`, quoted: mek})
					break
case 'phlogo':
					  pe = args.join('')
            var a = pe.split("|")[0];
            var b = pe.split("|")[1];
					reply(mess.wait)
					amel = await getBuffer(`https://api.zeks.xyz/api/phlogo?apikey=apivinz&text1=${a}&text2=${b}`)
					Christ.sendMessage(from, amel, image, {caption: `${command}`, quoted: mek})
					break
case 'glitch':
					  pe = args.join('')
            var a = pe.split("|")[0];
            var b = pe.split("|")[1];
					reply(mess.wait)
					amel = await getBuffer(`https://api.zeks.xyz/api/gtext?apikey=apivinz&text1=${a}&text2=${b}`)
					Christ.sendMessage(from, amel, image, {caption: `${command}`, quoted: mek})
					break
case 'hentai':
